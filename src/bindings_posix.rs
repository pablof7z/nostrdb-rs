...
pub type static_assert_reaction_string_must_be_8_bytes = [::std::os::raw::c_char; 1usize];
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type ndb_meta_clone_result = ::std::os::raw::c_uint;
extern "C" {
...
pub type static_assert_note_meta_entry_should_be_16_bytes = [::std::os::raw::c_char; 1usize];
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
